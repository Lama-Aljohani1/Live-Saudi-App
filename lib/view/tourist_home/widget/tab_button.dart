      ...
      builder: (controller) => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border(
              bottom: BorderSide(
                color: controller.selectedTab == index ? AppColors.primaryColor : Colors.transparent,
                width: 2,
              ),
            ),
          ),
          child: Text(
            ...
            style: TextStyle(
              fontSize: 16.sp,
              fontWeight: controller.selectedTab == index ? FontWeight.w600 : FontWeight.normal,
              color: controller.selectedTab == index ? Colors.black : Colors.grey,
            ),
          ),
        ),
      ),
