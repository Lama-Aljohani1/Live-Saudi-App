...
class _PlaceDetailsScreenState extends State<PlaceDetailsScreen> {
  void initState() {
    ...
    if (site != null) {
      controller.checkIfUserCanRate(site.id);
      controller.loadSiteReviews(site.id);
    }
  }
                      ...
                      return GestureDetector(
                        onTap: () {
                          if (controller.selectedSite != null) {
                            controller.toggleFavorite(controller.selectedSite!);
                          }
                        },
                        child: Container(
                          height: 48.h,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                child: SizedBox(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemBuilder: (_, i) {
                                      ...
                                      Uint8List? b;
                                      try {
                                        b = base64Decode(site.imagesBase64[i]);
                                      } catch (_) {
                                        b = null;
                                      }
                                      return GestureDetector(
                      ...
                      SizedBox(height: 24.h),
                      if (site.reviews.isNotEmpty || site.rating > 0)
                        SizedBox(
                          height: 40.h,
                          child: Stack(
                            children: [
                              if (site.reviews.length >= 6)
                                Positioned(
                                  left: 0,
                                  child: CircleAvatar(
                                    radius: 16.r,
                      ...
                      AnimatedSwitcher(
                        ...
                        child: controller.selectedTab == 0
                            ...
                            : Column(
                                key: ValueKey(
                                  'reviews_${site.reviews.length}_${site.rating}',
                                ),
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
                                  ...
                                  controller.siteReviews.isEmpty
                                      ? Text(
                                      ...
                                      : ListView.separated(
                                          ...
                                          itemCount:
                                              controller.siteReviews.length,
                                          separatorBuilder: (_, __) =>
                                              Divider(color: Colors.grey[300]),
                                          itemBuilder: (context, index) {
                                            final review =
                                                controller.siteReviews[index];
                      ...
                      if (controller.canRate)
                        CustomeButton(
                          ...
                          text: "Rate This Site",
                          onPressed: () {
                            controller.openRatingDialog(site.id);
                          },
                        ),
                    ],
                  ),
